...
struct GameLogicModel {
    private(set) var moves: [PlayWithAIModel.Move?]
    private var aiVM: PlayWithAIViewModel
    private var humanMoves: [PlayWithAIModel.Move]
    private var computerMoves: [PlayWithAIModel.Move]
    
    init(currentMove: [PlayWithAIModel.Move?]) {
        moves = currentMove
